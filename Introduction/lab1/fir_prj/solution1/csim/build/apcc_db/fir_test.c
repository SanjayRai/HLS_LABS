...
printf("\n\{ BEGIN @main\n");
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = bitcast [11 x i32]* %%taps to i8*, !dbg !5 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_4_count);
  llvm_cbe_tmp__1 = ( char *)(( char *)(&llvm_cbe_taps));
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = call i8* @memcpy(i8* %%1, i8* bitcast ([11 x i32]* @aesl_internal_main.taps to i8*), i32 44 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_5_count);
  ( char *)memcpy(( char *)llvm_cbe_tmp__1, ( char *)(( char *)(&aesl_internal_main_OC_taps)), 44u);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nReturn  = 0x%X",llvm_cbe_tmp__2);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%3 = call %%struct._iobuf* @fopen(i8* getelementptr inbounds ([8 x i8]* @aesl_internal_.str, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8]* @aesl_internal_.str1, i32 0, i32 0)) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_17_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = getelementptr inbounds [11 x i32]* %%taps, i32 0, i32 0, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_25_count);
  llvm_cbe_tmp__4 = (signed int *)(&llvm_cbe_taps[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 11
#endif
]);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = load i32* %%output, align 4, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_48_count);
  llvm_cbe_tmp__9 = (unsigned int )*(&llvm_cbe_output);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__9);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = call i32 (%%struct._iobuf*, i8*, ...)* @fprintf(%%struct._iobuf* %%3, i8* getelementptr inbounds ([10 x i8]* @aesl_internal_.str2, i32 0, i32 0), i32 %%storemerge10, i32 %%storemerge24, i32 %%17) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_49_count);
  fprintf((l_struct_OC__iobuf *)llvm_cbe_tmp__3, ( char *)((&aesl_internal__OC_str2[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 10
#endif
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fir(i32* %%output, i32* %%4, i32 %%9) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_32_count);
  fir((signed int *)(&llvm_cbe_output), (signed int *)llvm_cbe_tmp__4, llvm_cbe_tmp__6);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",llvm_cbe_tmp__6);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%. = select i1 %%10, i32 0, i32 1, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e__count);
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @fir(i32* %%output, i32* %%4, i32 %%12) nounwind, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_36_count);
...
llvm_cbe_tmp__36:
if (AESL_DEBUG_TRACE)
printf("\n  %%.8 = zext i1 %%15 to i32, !dbg !6 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe__2e_8_count);
...
llvm_cbe_tmp__35:
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = call i32 @fclose(%%struct._iobuf* %%3) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_56_count);
  fclose((l_struct_OC__iobuf *)llvm_cbe_tmp__3);
if (AESL_DEBUG_TRACE) {
printf("\nReturn  = 0x%X",llvm_cbe_tmp__12);
}
if (AESL_DEBUG_TRACE)
printf("\n  %%puts = call i32 @puts(i8* getelementptr inbounds ([31 x i8]* @aesl_internal_str, i32 0, i32 0)), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_puts_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = call i32 bitcast (i32 (...)* @system to i32 (i8*)*)(i8* getelementptr inbounds ([29 x i8]* @aesl_internal_.str4, i32 0, i32 0)) nounwind, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_57_count);
  llvm_cbe_tmp__13 = (unsigned int )system(( char *)((&aesl_internal__OC_str4[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 29
#endif
])));
...
llvm_cbe_tmp__38:
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_60_count);
  llvm_cbe_tmp__14 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%26 = getelementptr inbounds [0 x %%struct._iobuf]* %%25, i32 0, i32 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_61_count);
  llvm_cbe_tmp__15 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__14)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%27 = call i32 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i32 0, i32 0), i32 44, i32 1, %%struct._iobuf* %%26), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_62_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])), 44u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__15);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_63_count);
  llvm_cbe_tmp__17 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = getelementptr inbounds [0 x %%struct._iobuf]* %%28, i32 0, i32 1, !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_64_count);
  llvm_cbe_tmp__18 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__17)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = call i32 @fwrite(i8* getelementptr inbounds ([47 x i8]* @aesl_internal_.str6, i32 0, i32 0), i32 46, i32 1, %%struct._iobuf* %%29), !dbg !7 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_65_count);
  fwrite(( char *)((&aesl_internal__OC_str6[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 47
#endif
])), 46u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__18);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",46u);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_66_count);
  llvm_cbe_tmp__20 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = getelementptr inbounds [0 x %%struct._iobuf]* %%31, i32 0, i32 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_67_count);
  llvm_cbe_tmp__21 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__20)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = call i32 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i32 0, i32 0), i32 44, i32 1, %%struct._iobuf* %%32), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_68_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])), 44u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__21);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nArgument  = 0x%X",1u);
...
llvm_cbe_tmp__37:
if (AESL_DEBUG_TRACE)
printf("\n  %%35 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_70_count);
  llvm_cbe_tmp__23 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%36 = getelementptr inbounds [0 x %%struct._iobuf]* %%35, i32 0, i32 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_71_count);
  llvm_cbe_tmp__24 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__23)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = call i32 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i32 0, i32 0), i32 44, i32 1, %%struct._iobuf* %%36), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_72_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])), 44u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__24);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_73_count);
  llvm_cbe_tmp__26 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%39 = getelementptr inbounds [0 x %%struct._iobuf]* %%38, i32 0, i32 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_74_count);
  llvm_cbe_tmp__27 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__26)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%40 = call i32 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str7, i32 0, i32 0), i32 44, i32 1, %%struct._iobuf* %%39), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_75_count);
  fwrite(( char *)((&aesl_internal__OC_str7[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])), 44u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__27);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nArgument  = 0x%X",1u);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%41 = load [0 x %%struct._iobuf]** @_imp___iob, align 4, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_76_count);
  llvm_cbe_tmp__29 = (l_struct_OC__iobuf (*)[1])*(&_imp___iob);
if (AESL_DEBUG_TRACE)
printf("\n  %%42 = getelementptr inbounds [0 x %%struct._iobuf]* %%41, i32 0, i32 1, !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_77_count);
  llvm_cbe_tmp__30 = (l_struct_OC__iobuf *)(&(*llvm_cbe_tmp__29)[(((signed int )1u))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%43 = call i32 @fwrite(i8* getelementptr inbounds ([45 x i8]* @aesl_internal_.str5, i32 0, i32 0), i32 44, i32 1, %%struct._iobuf* %%42), !dbg !8 for 0x%I64xth hint within @main  --> \n", ++aesl_llvm_cbe_78_count);
  fwrite(( char *)((&aesl_internal__OC_str5[(((signed int )0u))
#ifdef AESL_BC_SIM
 % 45
#endif
])), 44u, 1u, (l_struct_OC__iobuf *)llvm_cbe_tmp__30);
if (AESL_DEBUG_TRACE) {
printf("\nArgument  = 0x%X",44u);
printf("\nArgument  = 0x%X",1u);
